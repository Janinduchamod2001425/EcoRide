  ...
  return (
    <div className='py-5'>
      ...
      <div className='bacgroundImage'>
        <p className='reportTitle'>All Users</p><Link to='http://localhost:3000/' className='dashboardLink'>Access the Admin Panel</Link>
        ...
        <div className='tableContainer'>
          ...
          <Table className='userTable' striped bordered hover>
            <thead>
              <tr>
                <th>Name</th>
                <th>Email</th>
