...
import { useGetbookingsByUserIdMutation } from '../slices/bookingApiSlice';
import '../styles/CusBookings.css';
...
const CustomerReservationScreen = () => {
    ...
    const [getBookingByCusId, { data: bookings = [] }] = useGetbookingsByUserIdMutation(cusId);
    ...
    return (
        <div className='py-5'>
            ...
            <div className='bacgroundImage'>
                <p className='reportTitle'>Vehicle Reservations</p>
