...
import { useGetPackageByCustomerIdMutation } from '../slices/packagesApiSlice';
import '../styles/CusPackages.css';
...
const CustomerPackagesScreen = () => {

    const { userInfo } = useSelector((state) => state.auth);
    const cusId = userInfo._id;

    const [getPackageByCusId, { data: packages = [] }] = useGetPackageByCustomerIdMutation(cusId);
    ...
    return (
        <div className='py-5'>
            ...
            <div className='bacgroundImage'>
                <p className='reportTitle'>Customized Package Details</p>
...
export default CustomerPackagesScreen