...
import reports from '../images/dashboard/Audit 1.png';
    ...
    return (
        <div className='py-5'>
            ...
            <div className='bacgroundImage4'>
                ...
                <div className='service1'><img src={ownvehi} className="serIm" /></div>
                <div className='service1'><img src={license} className="serIm" /></div>
                <div className='service1'><img src={reservation} className="serIm" /></div>
                ...
                <div className='service1'><img src={packages} className="serIm" /></div>
                <div className='service1'><img src={reports} className="serIm" /></div>
                <div className='service1'><img src={payments} className="serIm" /></div>
                <Link to='/admindashboard'><div className='service'><img src={settings} className="serIm" /></div></Link>

                <p className='serv5'>Packages</p>
                <p className='serv6'>Reports</p>
