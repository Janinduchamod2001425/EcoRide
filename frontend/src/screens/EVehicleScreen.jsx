...
// Vehicle Pages
import E_Cars from '../pages/E_CarsPage';
  ...
  return (
    <div className='py-5'>
      ...
      <div className='bacgroundImage'>
        ...
        <p className='vehiclesTopic'>E-Vehicles</p>

        <button className='vehiTypeBtn'>E - Cars</button>
        <button className='vehiTypeBtn'>E - Motor Bicycle</button>
        <button className='vehiTypeBtn'>E - Cycles</button>
        <button className='vehiTypeBtn'>E - Three Wheelers</button>
