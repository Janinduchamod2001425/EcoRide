                ...
                <div className='signUpForm'>
                    ...
                    <Form onSubmit={submitHandler}>
                        ...
                        <Form.Group className='set my-2' controlId='name'>
                            ...
                            <Form.Control className="textview" type='text' placeholder='Enter your full Name' value={name} onChange={(e) => setName(e.target.value)}></Form.Control>
                        </Form.Group>

                        <Form.Group className='set my-2' controlId='email'>
                            <Form.Label className="labelName fw-bold">Email Address</Form.Label>
                            <Form.Control className="textview" type='email' placeholder='Enter your valid Email' value={email} onChange={(e) => setEmail(e.target.value)}></Form.Control>
                        </Form.Group>

                        <Form.Group className='set my-2' controlId='contact'>
                            <Form.Label className="labelName fw-bold">Contact No.</Form.Label>
                            <Form.Control className="textview" type='number' placeholder='Enter new phone no.' value={contact} onChange={(e) => setContact(e.target.value)}></Form.Control>
                        </Form.Group>
                        ...
                        <Button type='submit' variant='primary' id='saveBTN'>Update</Button>
                    </Form>
                </div>
            </div>
